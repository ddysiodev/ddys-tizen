(function (global) {
  ...
  function createFocusManager(options) {
    ...
    function refresh(preferred) {
      ...
      if (preferred) {
        var preferredIndex = nodes.indexOf(preferred);
        if (preferredIndex >= 0) {
  ...
  function registerTvKeys(keys) {
    if (!global.tizen || !global.tizen.tvinputdevice || typeof global.tizen.tvinputdevice.registerKey !== 'function') {
